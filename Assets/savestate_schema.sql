...
-- Base catalog for all items (weapons, armor, gear, magic items, etc.)
...
-- Weapon-specific stats (1:1 with item_library)
...
-- Armor/shield-specific stats (1:1 with item_library)
...
-- Entity inventory — who has what items and what's equipped
...
-- Links items to the actions they grant when equipped
