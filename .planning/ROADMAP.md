...
Plans:
- [ ] 07-01: GameModelFormBuilder widget — renders form inputs from List<FieldSchema> via switch on inputType
- [ ] 07-02: WikiTypePicker refactored to consume isWikiPageType entity types from active GameModel
- [ ] 07-03: WikiCreateForm wired to GameModelFormBuilder; WikiPageType.fields call sites removed
...
| 7. Provider Rewiring | v2.0 GameModel | 0/3 | Not started | - |
